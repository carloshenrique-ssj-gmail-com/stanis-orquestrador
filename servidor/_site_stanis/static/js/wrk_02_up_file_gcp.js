function funcao_valida_salvamento_tarefa_up_file_gcp(){
...
function funcao_listar_tarefas_up_gcp(){
    let pagina = "listar_tarefas_up_file_gcp";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            let tableHtml = '';
            tableHtml += "<table border='1' id='tbl_1' class='tabela'><thead>";
            tableHtml += "<tr><td><strong>Id</strong></td>";
            tableHtml += "<td><strong>Desc.</strong></td>";
            tableHtml += "<td><strong>Resp.</strong></td>";
            tableHtml += "<td><strong>Origem</strong></td>";
            tableHtml += "<td><strong>Bucket</strong></td>";
            ...
            tableHtml += "<td><strong>Depen.</strong></td>";
