function funcao_valida_salvamento_tarefa_down_file_gcp(){
    ...
    if(txt_dir_origem.value == '' 
      ...
      if(txt_recorrencia.value == '3' &  txt_dia_mes.value == ''){
        ...
        let pagina = "salvar_down_file_gcp";
        $.ajax({
            type: 'GET',
            dataType: 'text',
            url: pagina,
...
function funcao_listar_tarefas_down_gcp(){
    let pagina = "listar_tarefas_down_file_gcp";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
