function funcao_valida_salvamento_tarefa_script_py(){
    ...
    let txt_tag_bloq = document.getElementById('txt_tag_bloq');
      ...
      if(txt_recorrencia.value == '3' &  txt_dia_mes.value == '')
        ...
        $.ajax({
            ...
            data: {
                ...
                txt_tag_bloq: txt_tag_bloq.value.trim().toUpperCase(),
                txt_host_fixo: txt_host_fixo.value.trim()         
            },
...
function funcao_limpa_campos(){
    ...
    document.getElementById('txt_tag_bloq').value='';
...
function funcao_listar_tarefas_py(){
    let pagina = "listar_tarefas_script_py";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>Script</strong></td>";
            ...
            tableHtml += "<td><strong>T.Bloq</strong></td>";
            ...
            tableHtml += "<td><strong>VA</strong></td>";             
            tableHtml += "</tr></thead>";
            if (data.length > 0){
                let cadeia = "";
                ...
                data.forEach(function(dados){
                    if (cadeia !== dados['cadeia']){
                        ...
                        tableHtml += "<td colspan='22' style='border: 2px; border-style: solid dashed; border-color: #09F; text-align: center; white-space: nowrap;'>";
                    ...
                    if(dados['tag_bloq'] === null){dados['tag_bloq'] = ''};
                    ...
                    if(dados['cadastrada_va'] == 1){
                        tableHtml += "<td><span title='" + dados['nome'] + "'>" + dados['usuario'] + "<img title='Variável de ambiente' src='static/images/static_img/chave_16px.png'></td></span>";
                    }else{
                    ...
                    tableHtml += "<td><p style='font-size:5px'>" + dados['tag_bloq'] + "</p></td>";
                    ...
                    tableHtml += "<td><span title='Variaveis de ambiente'><button type='button' id='" + dados['id_tarefa'] + "' class='btn_tab variavel_ambiente' onclick='funcao_chamar_modal_variaveis_ambiente(this.id);'>Ambiente</button></span></td>";
                    tableHtml += "</tr>";
                });
