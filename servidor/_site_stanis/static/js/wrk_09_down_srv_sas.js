function funcao_valida_salvamento_tarefa_down_sas(){
...
function funcao_listar_tarefas_down_sas(){
    let pagina = "listar_tarefas_down_sas";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>Destino</strong></td>";
