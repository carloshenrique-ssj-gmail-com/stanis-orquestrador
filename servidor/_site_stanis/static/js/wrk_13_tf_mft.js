function funcao_valida_salvamento_tarefa_mover_arquivo_mft(){
...
function funcao_listar_tarefas_tf_mft(){
    let pagina = "listar_tarefas_tf_mft";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>MFT</strong></td>";
            ...
            if (data.length > 0){
                ...
                data.forEach(function(dados){
                    if (cadeia !== dados['cadeia']){
                        ...
                        tableHtml += "<td colspan='23' style='border: 2px; border-style: solid dashed; border-color: #09F; text-align: center; white-space: nowrap;'>";
                    ...
                    tableHtml += "<td style='cursor: pointer;' onclick=\"funcao_atualizar_linha("+ dados['id_tarefa'] + ",13);\">" + dados['id_tarefa'] + "</td>";
                    ...
                    tableHtml += "<td><span title='Parar'><button type='button' id='" + dados['id_tarefa'] + "' class='btn_tab parar' onclick='if(identificaBtn(this.id,5,1) === true){funcao_atualizar_linha(id,13)};'>Parar</button></span></td>";
                    tableHtml += "<td><span title='Reiniciar'><button type='button' id='" + dados['id_tarefa'] + "' class='btn_tab reiniciar' onclick='if(identificaBtn(this.id,2,1) === true){funcao_atualizar_linha(id,13)};'>Reiniciar</button></span></td>";
