function funcao_valida_salvamento_tarefa_vbs(){
...
function funcao_listar_tarefas_vbs(){
    let pagina = "listar_tarefas_vbs";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>VBS</strong></td>";
