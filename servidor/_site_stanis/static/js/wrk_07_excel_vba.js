function funcao_valida_salvamento_excel_vba(){
      ...
      if(txt_recorrencia.value == '3' &  txt_dia_mes.value == '')
        ...
        $.ajax({
            ...
            data: {
                ...
                txt_tag_bloq: txt_tag_bloq.value.trim().replace("'","").replace(";"," ").toUpperCase(),
...
function funcao_listar_tarefas_excel_vba(){
    let pagina = "listar_tarefas_excel_vba";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>Excel</strong></td>";
            tableHtml += "<td><strong>Macro</strong></td>";
            ...
            tableHtml += "<td><strong>Bloq</strong></td>";
            ...
            if (data.length > 0){
                ...
                data.forEach(function(dados){
                    ...
                    tableHtml += "<td>" + dados['tag_bloq'] + "</td>";
