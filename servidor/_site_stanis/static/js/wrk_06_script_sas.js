function funcao_valida_salvamento_tarefa_egp_sas(){
...
function funcao_listar_tarefas_egp_sas(){
    let pagina = "listar_tarefas_egp_sas";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>EGP SAS</strong></td>";
