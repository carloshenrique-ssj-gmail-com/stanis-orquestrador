function funcao_valida_salvamento_tarefa_gatilho_script_py(){
    ...
    if(txt_dir_origem.value == '' 
      ...
      if(txt_recorrencia.value == '3' &  txt_dia_mes.value == '')
        ...
        let pagina = "salvar_gatilho_script_py";
        $.ajax({
            type: 'GET',
            dataType: 'text',
            url: pagina,
...
function funcao_listar_tarefas_gatilho_py(){
    let pagina = "listar_tarefas_gatilho_script_py";
    $.ajax({
        type: 'GET',
        dataType: 'json',
        url: pagina,
        ...
        success: function (data){
            ...
            tableHtml += "<td><strong>Função</strong></td>";
